...
var header = {
  ...
  address: "03028, Kyiv city, Nauky ave, 15",
}

var footer = {
  social: {
    email: {
      text: "petrenko@mail.com",
      href: "mailto:petrenko@mail.com",
    },
    phone: {
      text: "+380670000123",
      ...
      works: [
        {
          ...
          projects: [
            {
            name: "Resume",
            url: "https://drive.google.com/file/d/1LJXQwAKjv0C3rCMFl4ZLVeL9ttDBtf46/view?usp=share_link",
            about: "My personal biographie",
            stacks: [
              {
                name: "React.js",
              },
